...
;(function () {
    ...
    $(document).ready(function () {
        ...
        /* ---------------------------------------------
          vl custom menu
        --------------------------------------------- */
        function initVLCustomMenu() {
            const vlMenuCount = $(".vlmenu").length;
            const jsHamburgerCount = $(".js-hamburger").length;
            if (!vlMenuCount || !jsHamburgerCount) {
                setTimeout(()=> {
                    initVLCustomMenu();
                }, 100);
            } else {
        ...
        $(".team-card").click((event)=> {
            $(".modal", event.currentTarget.parentElement).modal();
        })
    });
